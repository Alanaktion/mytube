<template>
    <Listbox v-model="value">
        <div class="relative">
            ...
            >
                <ListboxOptions
                    class="origin-top-right absolute right-0 w-40 py-1 mt-2 z-10 rounded-md shadow-lg bg-white dark:bg-trueGray-800 border dark:border-trueGray-850"
                >
                    ...
                    >
                        <li
                            class="flex items-center appearance-none w-full px-4 py-2 text-sm"
                            :class="{
                    ...
                    <li
                        role="separator"
                        class="border-gray-200 dark:border-trueGray-850 my-1"
                    />
