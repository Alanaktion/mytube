    ...
    <header class="mb-3 md:mb-4 lg:mb-6">
        <div class="flex items-center gap-2">
            ...
            @if ($playlist->source_link)
                <a href="{{ $playlist->source_link }}" class="bg-transparent text-red-600 hover:bg-red-600 hover:text-white font-bold py-2 px-3 rounded-full flex" aria-label="View on YouTube" data-tooltip>
