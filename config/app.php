...
return [
    ...
    */
    ...
    // 'trusted_proxies' => env('APP_TRUSTED_PROXIES', '172.16.0.0/12'),
    ...
    |--------------------------------------------------------------------------
    |
    | This boolean value determines whether the robots.txt file for the site
    | should allow search engine indexing.
    |
    */
