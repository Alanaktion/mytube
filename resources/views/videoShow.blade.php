    ...
    <header class="sm:flex items-center mb-3 md:mb-4 lg:mb-6">
        ...
        <div class="sm:ml-auto flex gap-2">
            @if ($video->source_link)
                <a href="{{ $video->source_link }}" class="bg-red-700 hover:bg-red-600 text-white font-bold py-2 px-5 rounded-full flex items-center" aria-label="Watch on YouTube" data-tooltip>
