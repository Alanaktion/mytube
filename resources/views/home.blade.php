...
@section('content')
<div class="container">
    <h2 class="text-sm font-semibold text-gray-500 dark:text-trueGray-400 uppercase mb-3">{{ __('Recent videos') }}</h2>
    ...
    <h2 class="text-sm font-semibold text-gray-500 dark:text-trueGray-400 uppercase mb-3">{{ __('Recent playlists') }}</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-6 gap-4 lg:gap-6 mb-5 lg:mb-8 xl:mb-12">
    ...
    <h2 class="text-sm font-semibold text-gray-500 dark:text-trueGray-400 uppercase mb-3">{{ __('Recent channels') }}</h2>
