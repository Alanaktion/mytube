<div class="flex flex-col relative group">
    <a href="/playlists/{{ $playlist->uuid }}" class="block line-clamp-2 break-words leading-snug mb-1 text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
        {{ $playlist->title }}
