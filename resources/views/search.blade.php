...
@section('content')
<div class="container">
    <h1 class="text-2xl font-medium text-slate-600 dark:text-neutral-400 mb-6">{{ __('Search') }}</h1>

    <h2 class="text-sm font-semibold text-slate-500 dark:text-neutral-400 uppercase mb-3">{{ __('Videos') }}</h2>
    ...
    <h2 class="text-sm font-semibold text-slate-500 dark:text-neutral-400 uppercase mb-3">{{ __('Playlists') }}</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-6 gap-4 lg:gap-6 mb-5 lg:mb-8 xl:mb-12">
    ...
    <h2 class="text-sm font-semibold text-slate-500 dark:text-neutral-400 uppercase mb-3">{{ __('Channels') }}</h2>
