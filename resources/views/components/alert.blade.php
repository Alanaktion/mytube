...
$containerClass = match($type) {
    'error' => 'bg-red-100/50 dark:bg-red-900/50 border-red-100 dark:border-red-600',
    default => 'bg-emerald-100/50 dark:bg-emerald-900/50 border-emerald-100 dark:border-emerald-600',
};
...
@endphp
<div class="flex items-center border p-3 rounded-sm {{ $containerClass }}">
