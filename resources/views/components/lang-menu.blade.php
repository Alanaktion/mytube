<div x-data="{ open: false }" class="relative inline-block text-left">
    <button type="button"
        class="p-2 rounded-full text-sm font-medium focus:outline-none text-blue-600 focus:bg-gray-700 dark:focus:bg-trueGray-700 dark:text-blue-500 hover:bg-gray-300 dark:hover:bg-trueGray-700 tooltip-right"
        aria-label="{{ __('Change language') }}"
        :data-tooltip="!open"
        @click="open = true">
        <svg class="w-4 h-4" viewBox="0 0 52 52">
