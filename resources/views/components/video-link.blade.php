<div>
    <a href="/videos/{{ $video->uuid }}" class="block relative line-clamp leading-snug mb-1 text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">
        ...
        @if (!$video->file_path)
            <div class="absolute top-1 left-1 text-white" aria-label="No video file available" title="No video file available">
                <svg class="w-6 h-6 drop-shadow" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
