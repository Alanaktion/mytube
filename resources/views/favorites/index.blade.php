...
@section('content')
<div class="container">
    <h1 class="text-2xl font-medium text-gray-600 dark:text-trueGray-400 mb-6">{{ __('My Favorites') }}</h1>

    <h2 class="text-sm font-semibold text-gray-500 dark:text-trueGray-400 uppercase mb-2">{{ __('Videos') }}</h2>
    ...
    <h2 class="text-sm font-semibold text-gray-500 dark:text-trueGray-400 uppercase mb-2">{{ __('Playlists') }}</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-6 gap-4 lg:gap-6 pb-5 lg:mb-6">
    ...
    <h2 class="text-sm font-semibold text-gray-500 dark:text-trueGray-400 uppercase mb-2">{{ __('Channels') }}</h2>
